...
export const ELEVATION_SOURCES:Record<ElevationSourceId,ElevationSource>={
  mdt5:{id:'mdt5',kind:'terrain',label:'MDT05 · 5 m',shortLabel:'MDT05',resolutionM:5,coverage:'España',access:'mdt-wcs',coverageId:'Elevacion4258_5',attribution:'IGN/CNIG · WCS MDT de España · https://www.ign.es/web/politica-datos'},
  mdt25:{id:'mdt25',kind:'terrain',label:'MDT25 · 25 m',shortLabel:'MDT25',resolutionM:25,coverage:'España',access:'mdt-wcs',coverageId:'Elevacion4258_25',attribution:'IGN/CNIG · WCS MDT de España · https://www.ign.es/web/politica-datos'},
  mdt200:{id:'mdt200',kind:'terrain',label:'MDT200 · 200 m',shortLabel:'MDT200',resolutionM:200,coverage:'España',access:'mdt-wcs',coverageId:'Elevacion4258_200',attribution:'IGN/CNIG · WCS MDT de España · https://www.ign.es/web/politica-datos'},
  ...
  copernicus30:{id:'copernicus30',kind:'surface',label:'Copernicus DEM GLO-30 · MDS global',shortLabel:'Copernicus GLO-30',resolutionM:30,coverage:'Global · GLO-30 Public',access:'copernicus-cog',attribution:'Produced using Copernicus WorldDEM-30 © DLR e.V. 2010–2014 and © Airbus Defence and Space GmbH 2014–2018 provided under COPERNICUS by the European Union and ESA; all rights reserved · Las organizaciones responsables del programa Copernicus no asumen responsabilidad alguna por el uso de Copernicus WorldDEM-30. Condiciones para posteriores usuarios: https://documentation.dataspace.copernicus.eu/APIs/SentinelHub/Data/DEM/resources/license/License-COPDEM-30.pdf'},
};
