...
export function MdtMapPanel({imageUrl,studyExtent,viewState,onViewChange,points,selectedPointId,routes,isochroneLines=EMPTY_ISOCHRONE_LINES,isochroneSurface,onHover,userLocation,zoomToStudyExtentToken,hoverEnabled=true,onPointerCoordinate,selectionMarkerCoordinate}:MdtMapPanelProps){
