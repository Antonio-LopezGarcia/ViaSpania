...
const formatLevel=(level:number,unit:string)=>unit==='s'?`${(level/60).toLocaleString('es-ES',{maximumFractionDigits:1})} min`:`${level.toLocaleString('es-ES',{maximumFractionDigits:1})} ${unit}`;
